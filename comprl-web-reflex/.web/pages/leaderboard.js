...
export function Errorboundary_4a1075472a1f7556c2f14ecc944fa1b5 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
<Fragment_3377214878f23e1eea10b0248f0b69fc/>
</Fragment>
<NextHead>

<title>

{"ComprlWeb | Leaderboard"}
</title>
...
export function Fragment_3377214878f23e1eea10b0248f0b69fc () {
...
<DataTableGrid columns={["Ranking", "Username", "\u00b5 / \u03a3"]} data={reflex___state____state__comprl_web___reflex_local_auth___local_auth____local_auth_state__comprl_web___protected_state____protected_state.ranked_users} search={true} sort={false}/>
</RadixThemesFlex>
</Fragment>
) : (
  <Fragment>
...
export default function Component() {
  ...
  return (
    <Errorboundary_4a1075472a1f7556c2f14ecc944fa1b5/>
  )
}

...
export function Fragment_a7c108a9e28acb16cbaf21500a18581e () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_630850747e0e4d6083b53130221a7742 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["key"] : getRefValue(refs["ref_key"]), ["username"] : getRefValue(refs["ref_username"]), ["password"] : getRefValue(refs["ref_password"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_630850747e0e4d6083b53130221a7742}>
...
export function Errorboundary_6d205880a3b6eee84be3879faafedb14 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
<Fragment_a7c108a9e28acb16cbaf21500a18581e/>
</RadixThemesFlex>
</RadixThemesFlex>
</Fragment>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_6d205880a3b6eee84be3879faafedb14/>
  )
}

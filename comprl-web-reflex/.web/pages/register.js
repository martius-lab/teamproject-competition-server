...
export function Errorboundary_549d70ad39b19abaecf8dd7ab399bdad () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
<Fragment_f536fa02e639800b9a5c357ae5df5d88/>
</RadixThemesFlex>
</RadixThemesFlex>
</Fragment>
<NextHead>
...
export function Fragment_f536fa02e639800b9a5c357ae5df5d88 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_137eae469a843dcf767927b96f90a7d1 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["key"] : getRefValue(refs["ref_key"]), ["password"] : getRefValue(refs["ref_password"]), ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_137eae469a843dcf767927b96f90a7d1}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_549d70ad39b19abaecf8dd7ab399bdad/>
  )
}

...
export function Fragment_59766b4c5155aae1e6af34b178c0686d () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_1c739e9cfda93567b26d07da0a01ec2c = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["confirm_password"] : getRefValue(refs["ref_confirm_password"]), ["username"] : getRefValue(refs["ref_username"]), ["password"] : getRefValue(refs["ref_password"]), ["key"] : getRefValue(refs["ref_key"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_1c739e9cfda93567b26d07da0a01ec2c}>
...
export function Errorboundary_29361c834d7236c59c1dcbc757b85d68 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
export function Fragment_9c1046c4995d7f3aab3ce2e068474102 () {
...
export default function Component() {
  ...
  return (
    <Errorboundary_29361c834d7236c59c1dcbc757b85d68/>
  )
}

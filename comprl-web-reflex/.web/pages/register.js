...
export function Fragment_4d85cb2b647b0fd4765b725793bc8355 () {
  ...
  const ref_confirm_password = useRef(null); refs["ref_confirm_password"] = ref_confirm_password;
    ...
    const handleSubmit_0d509363d5b6d7a016b60e4c8123cebf = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({ ["password"] : getRefValue(refs["ref_password"]), ["key"] : getRefValue(refs["ref_key"]), ["username"] : getRefValue(refs["ref_username"]), ["confirm_password"] : getRefValue(refs["ref_confirm_password"]) })};
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_0d509363d5b6d7a016b60e4c8123cebf}>
...
export function Fragment_18ed2e55e8de9c306d8b0eb22767f376 () {
...
export function Errorboundary_e1bb186413fdf2538175b49cd14dcda9 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
export default function Component() {
  ...
  return (
    <Errorboundary_e1bb186413fdf2538175b49cd14dcda9/>
  )
}
